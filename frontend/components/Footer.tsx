    ...
    <footer className="bg-ak-secondary text-white mt-12">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">AkTrendFlare</h3>
          ...
          <div>
            ...
            <p className="text-gray-300">Email: support@aktrendflare.com</p>
            <p className="text-gray-300">Phone: +91 1800-123-4567</p>
          </div>
        </div>
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
          <p>&copy; 2024 AkTrendFlare. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
